...
```
效果：
![添加元素](添加元素.png "添加元素"){:width=300 height=300}
##### 删除
...
```
- `$("ul").remove();`
  ![元素删除1](元素删除1.png "元素删除1"){:width=40 height=40}
- `$("ul").html("");`或`$("ul").empty();`
  ![元素删除2](元素删除2.png "元素删除2"){:width=60 height=60}
### 尺寸/位置操作
##### 尺寸
| 语法                                | 用法                            |
| ----------------------------------- | ------------------------------- |
...
```
![尺寸操作1](尺寸操作1.png "尺寸操作1"){:width=200 height=200}
```
const div = $(".test");
...
```
![位置](位置.png "位置"){:width=200 height=200}
```
const div = $(".inner");
...
```
![位置2](位置2.png "位置2"){:width=200 height=200}
...
```
![事件自动触发1](事件自动触发1.png "事件自动触发1"){:width=30 height=30}
使用
```
$("input").focus();
$("input").trigger("focus");
...
```
刷新页面后就是这样的
![事件自动触发2](事件自动触发2.png "事件自动触发2"){:width=30 height=30}
